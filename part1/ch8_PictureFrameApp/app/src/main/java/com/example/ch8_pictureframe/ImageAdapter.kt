...
import com.example.ch8_pictureframe.databinding.ItemImageBinding
import com.example.ch8_pictureframe.databinding.ItemLoadMoreBinding
...
sealed class ImageItems { // 자기 자식이 어떤게 있는지 알고 있음
    data class Image(
        val uri: Uri,
    ) : ImageItems()
