package com.example.ch5_calculate
...
import com.example.ch5_calculate.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun equalClicked(view : View) {
        ...
        val secondNumber = firstNumberText.toString().toBigDecimal()
    ...
    private fun updateEquationTextView() {
        ...
        binding.euqationText.text = "$firstNumberText $operatorText $secondNumberText"
    }
}