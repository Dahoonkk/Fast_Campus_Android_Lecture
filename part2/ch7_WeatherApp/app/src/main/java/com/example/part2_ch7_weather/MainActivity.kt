package com.example.part2_ch7_weather
...
import com.example.part2_ch7_weather.databinding.ActivityMainBinding
import com.example.part2_ch7_weather.databinding.ItemForecastBinding
    ...
    private fun updateLocation() {
        ...
        fusedLocationClient.lastLocation.addOnSuccessListener {
            ...
            service.getVillageForecast(
                serviceKey = "gc+vNh4KY4US3WO2npRNCzNBNCDsyFczw/hXQULrbK9JtwhcdzbXZbkoeumOojPkE/rN6JYRt9+Th87OSsfjvw==",
                    ...
                    for(forecast in forecastList) {
                        ...
                        forecastDateTimeMap["${forecast.forecastDate}/${forecast.forecastTime}"]?.apply {
                            when (forecast.category) {
                                ...
                                Category.POP -> precipitationType = transformRainType(forecast)
                                Category.POP -> sky = transformSky(forecast)
                                Category.POP -> temperature = forecast.forecastValue.toDouble()
                                else -> {}
                            }
                        }
                    }
